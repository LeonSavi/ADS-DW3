...
def plot_gap_rmse(df: pd.DataFrame, k:int =8):
    """
    Plot the gap and RMSE in the various cross validation sets.
    """
...
def cv_sum_bars(summ_table: pd.DataFrame, k:int = 8):
    """
    Compute the mean of the metrics across cross validation folds and adds the std.
    """
...
- Leonardo Saviane - Optuna Optimisation, Writing about this, description of a few models, graphs about results,
- Thomas Rietman - Early comparison, combining all the code in qmd, main story and cleanup, 
